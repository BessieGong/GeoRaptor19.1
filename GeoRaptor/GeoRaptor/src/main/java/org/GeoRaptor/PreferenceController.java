...
public class PreferenceController implements Controller {
	...
	private static final int CONTEXT_MENU_1_CMD_ID = Ide.findOrCreateCmdID("CONTEXT_MENU_1_ACTION_ID");
	private static final int CONTEXT_MENU_2_CMD_ID = Ide.findOrCreateCmdID("CONTEXT_MENU_2_ACTION_ID");
	...
	private void show (String message) {
		JOptionPane.showMessageDialog(null, message, PreferenceResources.getString("DIALOG_SHOW_TITLE"), JOptionPane.INFORMATION_MESSAGE);
	}
	...
	public boolean handleEvent(IdeAction action, Context context) {
		...
		if (cmdId == CONTEXT_MENU_1_CMD_ID) {
			handleConnection(context);			
		} else if (cmdId == CONTEXT_MENU_2_CMD_ID) {
